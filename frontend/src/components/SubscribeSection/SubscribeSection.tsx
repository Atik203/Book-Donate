...
const SubscribeSection: React.FC = () => {
  return (
    <div className="bg-white shadow-md py-16 md:py-24 rounded-md">
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-6 lg:grid-cols-12 lg:gap-8 lg:px-8">
        ...
        <form className="w-full max-w-md lg:col-span-5 lg:pt-2">
          <div className="flex gap-x-4">
            ...
            <button
              type="submit"
              className="flex-none rounded-md bg-navPrimary px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
            >
              Subscribe
            </button>
          </div>
          <p className="mt-4 text-sm leading-6 text-gray-900">
            ...
            <a className="font-semibold text-black cursor-pointer hover:underline hover:text-blue-500">
              privacy&nbsp;policy
            </a>
            .
          </p>
